...
function inicializarBarbeirosPage() {
    ...
    form.addEventListener('submit', async function(event) {
      ...
      if (!nome || !telefone || !email || !dataContratacao || isNaN(comissao)) {
        Swal.fire({
          icon: 'warning',
      ...
      try {
        ...
        barbeiros.forEach(b => {
          ...
          li.innerHTML = `
            ...
            <div class="botoes">
              <button class="editar" onclick="editarBarbeiro(${b.idBarbeiro}, '${b.nome}', '${b.telefone}', '${b.email}', '${b.dataContratacao}', ${b.ativo}, ${b.comissao})">✎</button>
    ...
    function editarBarbeiro(id, nome, telefone, email, dataContratacao, ativo, comissao) {
